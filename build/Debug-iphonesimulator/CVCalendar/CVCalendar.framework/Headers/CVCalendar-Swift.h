...
@property (nonatomic, readonly, assign) CVCalendarView * _Nonnull calendarView;
...
@property (nonatomic, readonly) double toggleDateAnimationDuration;
...
@property (nonatomic, strong) UIColor * _Nullable dayofWeekBackgroundColor;
...
- (UIColor * _Nonnull)dayOfWeekTextColorBy:(enum CVCalendarWeekday)weekday;
- (UIColor * _Nonnull)dayOfWeekBackGroundColorBy:(enum CVCalendarWeekday)weekday;
- (UIColor * _Nonnull)dayOfWeekTextColor;
- (UIColor * _Nonnull)dayOfWeekBackGroundColor;
...
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)initialLoad:(NSDate * _Nonnull)date SWIFT_METHOD_FAMILY(none);
...
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)mapDayViews:(SWIFT_NOESCAPE void (^ _Nonnull)(CVCalendarDayView * _Nonnull))body;
@end
...
/**
  Default text color.
*/
@property (nonatomic, strong) UIColor * _Nullable dayLabelWeekdayDisabledColor;
...
- (UIFont * _Nonnull)dayLabelFontBy:(enum CVCalendarWeekday)weekDay status:(enum CVStatus)status present:(enum CVPresent)present;
...
- (UIColor * _Nullable)dayLabelColorBy:(enum CVCalendarWeekday)weekDay status:(enum CVStatus)status present:(enum CVPresent)present;
- (UIColor * _Nonnull)dayLabelWeekdayDisabledColor;
...
- (CGFloat)dayLabelSizeBy:(enum CVCalendarWeekday)weekDay status:(enum CVStatus)status present:(enum CVPresent)present;
...
- (UIColor * _Nullable)dayLabelBackgroundColorBy:(enum CVCalendarWeekday)weekDay status:(enum CVStatus)status present:(enum CVPresent)present;
...
- (UIColor * _Nonnull)topMarkerColor;
@end
...
- (double)toggleDateAnimationDuration;
...
- (BOOL)shouldSelectDayView:(CVCalendarDayView * _Nonnull)dayView;
...
- (nonnull instancetype)initWithDate:(NSDate * _Nonnull)date calendar:(NSCalendar * _Nonnull)calendar OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithDay:(NSInteger)day month:(NSInteger)month week:(NSInteger)week year:(NSInteger)year calendar:(NSCalendar * _Nonnull)calendar OBJC_DESIGNATED_INITIALIZER;
...
@interface CVDate (SWIFT_EXTENSION(CVCalendar))
- (NSDate * _Nullable)convertedDateWithCalendar:(NSCalendar * _Nonnull)calendar;
@end
